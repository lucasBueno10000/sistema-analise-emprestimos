...
1. **Introdução (30s)**
   - "Este é o sistema de análise de empréstimos que desenvolvi"
...
3. **Teste Etapa 1 (2min)**
   - Análise de crédito
   - Explicar cada campo da resposta
   - Mostrar diferentes cenários

4. **Teste Etapa 2 (2min)**
   - Upload de XML
   - Upload de CNAB
   - Mostrar validação de notas

5. **Arquitetura (2min)**
   - Explicar estrutura de pastas
   - Mostrar código dos services
   - Explicar como seria com APIs reais
